...
function cake(x, y) {
    ...
    // x - total candles
    // y - number of candles that will fall from the provided string

    var letterNumber = (char) => {
        var alph = [
    ...
    for (i = 0; i < y.length; i++) {
        ...
        var charNumber = letterNumber(char);
        sum += (i % 2 == 0) ? charCode : charNumber;
    }
